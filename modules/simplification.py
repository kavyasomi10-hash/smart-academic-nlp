...
# Stage 1: Vocabulary Replacement (YOUR OWN CODE)
# Stage 2: T5-base Sentence Restructuring

from transformers import T5ForConditionalGeneration, T5Tokenizer
import torch
import re

# YOUR OWN vocabulary dictionary
# Maps complex academic terms to simple equivalents
SIMPLIFY_VOCAB = {
    ...
    "refraction": "when light bends as it passes through a substance",
    ...
    "marginalisation": "pushing a group to the edges of society",
    "exploitation": "using someone unfairly for your benefit",
...
class TextSimplifier:
    ...
    def _replace_hard_words(self, text):
        ...
        for hard, simple in sorted(
                SIMPLIFY_VOCAB.items(), key=lambda x: -len(x[0])):
